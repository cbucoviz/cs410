...
sitems[5]=["<p class='indent'>Password: <input type='password name='login_password' size='20'></p>", ""]
sitems[6]=["<p id='login_button_indent'><input type='submit' value='Login'/></p></form>", ""]
sitems[7]=["<p class='indent'><u><i>Not a member yet? Register Now!</i></u></p>", "register.jsp"]
sitems[8]=["", ""]
sitems[9]=["", ""]
sitems[10]=["", ""]
sitems[11]=["", ""]
sitems[12]=["Return to Home", "home.jsp"]
sitems[13]=["", ""]
sitems[14]=["About", ""]
